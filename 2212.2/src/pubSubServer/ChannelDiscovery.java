...
public class ChannelDiscovery {
	...
	private static ChannelDiscovery instance = null;	//set the initial instances of ChannelAccessControl objects to null
	
	public static ChannelDiscovery getInstance() {		//get instance method checks if there has already been an instance created
		if(instance == null)				//if not then it creates an instance
			instance = new ChannelDiscovery();	//return the instance
		return instance;
	}
