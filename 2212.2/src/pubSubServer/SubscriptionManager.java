...
public class SubscriptionManager {
	...
	private static SubscriptionManager instance = null;	//set the initial instances of ChannelAccessControl objects to null
	
	public static SubscriptionManager getInstance() {	//get instance method checks if there has already been an instance created
		if(instance == null) {				//if not then it creates an instance
			instance = new SubscriptionManager();	//return the instance
		}
		return instance;
	}
